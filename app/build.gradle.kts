...
android {
    ...
    val provider = "com.keepass.provider"
    ...
    defaultConfig {
        ...
        buildConfigField("String", "PROVIDER_AUTHORITY", "\"$provider\"")
        
        manifestPlaceholders["googleAndroidBackupAPIKey"] = "unused"
        manifestPlaceholders["googlePlayServicesPackage"] = gmsPackage
        manifestPlaceholders["providerAuthority"] = provider
        manifestPlaceholders["readFieldPermission"] = "com.kunzisoft.keepass.permission.READ_FIELD"
    }
